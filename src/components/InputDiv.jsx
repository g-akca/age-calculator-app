function InputDiv({ 
  ...
  return (
    <div className="flex flex-col gap-2">
      <label htmlFor={label} className={`uppercase text-[12px] leading-base tracking-[4px] font-bold ${hasError ? "text-red-400" : "text-grey-500"}`}>
        {label}
      </label>
      ...
      {error && (!sharedDateError || showDateMessage) && (
        <p className="text-red-400 text-[12px] leading-base italic">
          {error.message}
        </p>
      )}
    </div>
